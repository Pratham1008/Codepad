  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto w-full flex flex-col h-full overflow-y-auto">
      <div className="flex flex-col md:flex-row justify-between md:items-end gap-4 mb-8">
        <div>
          <h1 className="font-headline-md text-2xl font-bold text-on-surface">Projects Dashboard</h1>
          <p className="text-sm text-on-surface-variant mt-1">Manage and view your code projects.</p>
        </div>
        <a
          href="/editor"
